describe 'Classical B tickets', ->
  ...
  describe "missing highlights", ->
    it "it should highlight the machine keyword (issue 2)", ->
      ...
      expect(tokens[4]).toEqual value: 'VARIABLES', scopes: [ 'source.classicalb', 'meta.machine.classicalb', 'storage.type.clause.classicalb' ]
      expect(tokens[6]).toEqual value: 'x', scopes: [ 'source.classicalb', 'meta.machine.classicalb', 'identifier.classicalb' ]
      expect(tokens[8]).toEqual value: 'END', scopes: [ 'source.classicalb', 'meta.machine.classicalb', 'storage.type.machine.end.classicalb' ]
